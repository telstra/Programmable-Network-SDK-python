...
class VportsApi(object):
    ...
    def inventoryvportvportuuidget(self, vportuuid, **kwargs):  # noqa: E501
        """Get information about the specified VPort  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.inventoryvportvportuuidget(vportuuid, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.inventoryvportvportuuidget_with_http_info(vportuuid, **kwargs)  # noqa: E501
        else:
            (data) = self.inventoryvportvportuuidget_with_http_info(vportuuid, **kwargs)  # noqa: E501
            return data

    def inventoryvportvportuuidget_with_http_info(self, vportuuid, **kwargs):  # noqa: E501
        """Get information about the specified VPort  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.inventoryvportvportuuidget_with_http_info(vportuuid, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method inventoryvportvportuuidget" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('vportuuid' not in params or
            ...
            raise ValueError("Missing the required parameter `vportuuid` when calling `inventoryvportvportuuidget`")  # noqa: E501
