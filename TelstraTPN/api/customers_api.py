...
class CustomersApi(object):
    ...
    def accountcustomeruuidget(self, customeruuid, **kwargs):  # noqa: E501
        ...
        >>> thread = api.accountcustomeruuidget(customeruuid, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.accountcustomeruuidget_with_http_info(customeruuid, **kwargs)  # noqa: E501
        else:
            (data) = self.accountcustomeruuidget_with_http_info(customeruuid, **kwargs)  # noqa: E501
            return data

    def accountcustomeruuidget_with_http_info(self, customeruuid, **kwargs):  # noqa: E501
        """Get account information details  # noqa: E501

        Get the account information for the specified customer  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.accountcustomeruuidget_with_http_info(customeruuid, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method accountcustomeruuidget" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('customeruuid' not in params or
            ...
            raise ValueError("Missing the required parameter `customeruuid` when calling `accountcustomeruuidget`")  # noqa: E501
