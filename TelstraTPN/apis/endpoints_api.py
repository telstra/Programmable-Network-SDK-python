...
class EndpointsApi(object):
    ...
    def inventory_endpoint_by_endpointuuid_get(self, endpointuuid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_endpoint_by_endpointuuid_get(endpointuuid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.inventory_endpoint_by_endpointuuid_get_with_http_info(endpointuuid, **kwargs)
        else:
            (data) = self.inventory_endpoint_by_endpointuuid_get_with_http_info(endpointuuid, **kwargs)
            return data

    def inventory_endpoint_by_endpointuuid_get_with_http_info(self, endpointuuid, **kwargs):
        """
        Get information about the specified endpoint
        Get information about the specified endpoint
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_endpoint_by_endpointuuid_get_with_http_info(endpointuuid, callback=callback_function)
        ...
        # verify the required parameter 'endpointuuid' is set
        if ('endpointuuid' not in params) or (params['endpointuuid'] is None):
            raise ValueError("Missing the required parameter `endpointuuid` when calling `inventory_endpoint_by_endpointuuid_get`")
    ...
    def inventory_endpoints_customeruuid_by_customeruuid_get(self, customeruuid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_endpoints_customeruuid_by_customeruuid_get(customeruuid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.inventory_endpoints_customeruuid_by_customeruuid_get_with_http_info(customeruuid, **kwargs)
        else:
            (data) = self.inventory_endpoints_customeruuid_by_customeruuid_get_with_http_info(customeruuid, **kwargs)
            return data

    def inventory_endpoints_customeruuid_by_customeruuid_get_with_http_info(self, customeruuid, **kwargs):
        """
        Get list of endpoints for a customer
        Get list of endpoints for a customer
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_endpoints_customeruuid_by_customeruuid_get_with_http_info(customeruuid, callback=callback_function)
        ...
        if ('customeruuid' not in params) or (params['customeruuid'] is None):
            raise ValueError("Missing the required parameter `customeruuid` when calling `inventory_endpoints_customeruuid_by_customeruuid_get`")
    ...
    def inventory_regularendpoint_post(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_regularendpoint_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.inventory_regularendpoint_post_with_http_info(**kwargs)
        else:
            (data) = self.inventory_regularendpoint_post_with_http_info(**kwargs)
            return data

    def inventory_regularendpoint_post_with_http_info(self, **kwargs):
        """
        Create Physical (Port) Endpoint
        Create Physical (Port) Endpoint
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_regularendpoint_post_with_http_info(callback=callback_function)
    ...
    def inventory_vnfendpoint_post(self, **kwargs):
        """
        Create VNF Endpoint
        Create VNF Endpoint
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_vnfendpoint_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.inventory_vnfendpoint_post_with_http_info(**kwargs)
        else:
            (data) = self.inventory_vnfendpoint_post_with_http_info(**kwargs)
            return data

    def inventory_vnfendpoint_post_with_http_info(self, **kwargs):
        """
        Create VNF Endpoint
        Create VNF Endpoint
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_vnfendpoint_post_with_http_info(callback=callback_function)
