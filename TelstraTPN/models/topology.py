...
class Topology(object):
    ...
    def __init__(self, created_by=None, creation_date=None, customer_uuid=None, deletion_date=None, description=None, guid_topology_id=None, name=None, nsd_uuid=None, status=None, uuid=None):  # noqa: E501
