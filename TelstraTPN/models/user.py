...
class User(object):
    ...
    def __init__(self, emailaddress=None, firstname=None, jobtitle=None, lastname=None, middlename=None, phoneext=None, phonenumber=None, phonetype=None, status=None, title=None, usercountry=None, useruuid=None):  # noqa: E501
